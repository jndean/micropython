...
class InitVertex: public poplar::Vertex {
    ...
    bool compute() {        
        ...
        poppy_add_memory_as_array("dataBlock", &dataBlock[0], dataBlock.size(), 'b');
        poppy_add_memory_as_array("rwFlag", &*rwFlag, 1, 'i');
        poppy_add_memory_as_array("diskPos", &*diskPos, 1, 'i');
